"""
Django settings for inboxpilot project.
"""
...
WSGI_APPLICATION = 'inboxpilot.wsgi.application'
...
#         'NAME': config('DB_NAME', default='inboxpilot'),
...
AUTHENTICATION_BACKENDS = [
    'api.authentication.EmailOrUsernameBackend',  # Custom backend
